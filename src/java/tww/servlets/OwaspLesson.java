 ...
 * @author Lenovo
 */
@WebServlet(name = "owasp", urlPatterns = {"/owasp"})
public class OwaspLesson extends HttpServlet {
   @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session == null) {
            ...
            request.getRequestDispatcher("/WEB-INF/Owasp.html").include(request, response);
        }
